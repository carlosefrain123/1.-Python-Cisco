""" Escenario
Tu tarea aquí es aún más especial que antes: ¡Debes rediseñar el devorador de vocales (feo) del laboratorio anterior 
y crear un mejor devorador de vocales (lindo) mejorado! Escribe un programa que use:
...
emplea la ejecución condicional y la instrucción continue para "devorar" las siguientes vocales 
...
palabra_completa=palabra.upper()
seguimiento=" "
for i in palabra_completa:
    if i in "AEIOU":
        continue
    seguimiento+=i
print("El valor final es: "+str(seguimiento))