...
de la palabra Espatifilo, grite involuntariamente a la consola la siguiente cadena: "¡Espatifilo es la mejor planta de todas!"
...
flor=input("Ingrese el nombre de una flor: ")

while(flor!="Espatifilo"):
    if(flor=="espatifilo"):
        print("No, ¡quiero un gran Espatifilo!")
    else:
        print("¡Espatifilo!, ¡No "+str(flor)+"!")
    flor=input("Ingrese el nombre de una flor: ")
