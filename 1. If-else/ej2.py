""" Érase una vez una tierra de leche y miel - habitada por gente feliz y próspera. La gente pagaba impuestos, por supuesto -
su felicidad tenía límites. El impuesto más importante, denominado Impuesto Personal de Ingresos (IPI, para abreviar) 
...
si el ingreso era superior a esta cantidad, el impuesto era igual a 14,839 pesos y 2 centavos, más el 32% del excedente
sobre 85,528 pesos.
...
while(ingreso<0):
    print("El sueldo no tiene que ser negativo")
    ingreso=float(input("Ingrese  de nuevo su sueldo:"))
...
if (ingreso>1000):
    ...
    print("El impuesto es: "+str(round(impuesto)))
else:
